...
@export var layer_name: String = "Bass"
@export var fmod_parameter: String = "Layer_Bass"
...
func _ready() -> void:
	TokenTracker.register_token("Set 3", self)
...
func collect_token() -> void:
	stack_position = TokenTracker.get_stack_position("Set 3", self)
