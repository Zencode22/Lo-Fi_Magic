...
@export_enum(
	...
	"Violin_Idle",
	"Violin",
	) var idle_animation_name: String = "None"
...
@onready var AP: AnimationPlayer = $Band_Member/AnimationPlayer
@onready var HeadMesh: MeshInstance3D = $Band_Member/Armature_TempChar/Skeleton3D/Temp_Head
@onready var BodyMesh: MeshInstance3D = $Band_Member/Armature_TempChar/Skeleton3D/Temp_Body
